...
void IntegratorAbstract::initializeIntegrator(double ph, SolidMesh& pM, MatrixXd& pTV, MatrixXi& pTT, MatrixXd& pB){
	//Constants
	vertsNum = pTV.rows();
...
void IntegratorAbstract::printObject(string printToHere, int numberOfPrints, MatrixXd& TV, MatrixXi& TT, MatrixXd& B)
{
	double refinement = 9;
